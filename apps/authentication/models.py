...
class UserManager(BaseUserManager):
    ...
    def create_user(self, email, password=None, **extra_fields):
        ...
        extra_fields.setdefault('account_status',
...
class AccountStatus(models.TextChoices):
    FORCE_CHANGE_PASSWORD = "FORCE_CHANGE_PASSWORD", _("Force change password")
...
class User(AbstractUser):
    ...
    class Meta:
        permissions = [
            ("list_users", "Can view a list of users")]
...
class UserActivity(DatedModel):
    """User activity model to track user actions."""
